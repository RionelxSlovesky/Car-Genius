    ...
    return (
        <div className="carousel w-full">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div>
                    <div className='absolute transform -translate-y-1/2 left-5 right-5'>
                        <h1 className='text-4xl text-center text-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, aut.</h1>
                    </div>
                    <div className="absolute flex justify-end gap-4 transform -translate-y-1/2 left-5 right-5 bottom-0">
                        <a href="#slide6" className="btn btn-circle hover:bg-red-600">❮</a>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end gap-4 transform -translate-y-1/2 left-5 right-5 bottom-0">
                    <a href="#slide3" className="btn btn-circle hover:bg-red-600">❮</a>
                    <a href="#slide5" className="btn btn-circle hover:bg-red-600">❯</a>
                </div>
            </div>
